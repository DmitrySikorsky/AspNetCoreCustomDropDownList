...
“[ASP.NET Core Custom Drop Down List](https://medium.com/@dmitry.a.sikorsky/asp-net-core-custom-drop-down-list-86bcd60f2cf2)”
post on the [Dmitry Sikorsky’s blog](https://medium.com/@dmitry.a.sikorsky). It demonstrates how to build custom drop down list
